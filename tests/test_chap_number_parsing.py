...
class TestMangaPillGetChaptersStoresNumericChap:
    ...
    def _build_context_with_chapter_html(self, chapter_html: str):
        ...
        return SiteComicContext(
            comic={"url": "https://mangapill.com/manga/9999/test"},
            title="Test",
            identifier="9999",
            soup=soup,
        )
...
class TestComixChapNormalization:
    ...
    method (which requires Patchright + comix.to API access). The contract
    ...
    def test_none_number_falls_back_to_title(self):
        # The user's reported failure mode: comix.to returns null `number`
