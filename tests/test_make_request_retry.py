...
def test_503_with_body_retries_and_succeeds_on_recovery():
    ...
    resp = mod.make_request("https://api.mangadex.org/manga/abc", scraper)
...
def test_503_with_body_exhausts_retries_and_raises():
    ...
    with pytest.raises(requests.HTTPError):
        mod.make_request("https://api.mangadex.org/manga/abc", scraper)
...
def test_400_with_body_returned_for_caller_inspection():
    ...
    resp = mod.make_request("https://api.mangadex.org/manga", scraper)
